...
Storage / files: CSV sample extracts, production extracts from data warehouse or S3
Version control: GitHub

4. Data source
Source: Kaggle shoes dataset, cleaned and anonymized for analysis.
...
Vertical bar: Compare category sales and velocity.
Horizontal bar: Compare country revenue for geographic prioritization.
Pie chart: Visualize color mix for assortment decisions.
Multi‑series line: Compare channel trends across brands to inform marketing allocation.
Business impact & insights (what this dashboard drives)
Revenue and margin improvement: Identify high‑margin SKUs and channels to increase gross margin by focusing promotions where margin is protected.
Inventory efficiency: Reduce overstock and carrying costs by reallocating safety stock to high‑velocity categories and regions.
Marketing ROI uplift: Reallocate spend from underperforming channels to high‑conversion channels to improve campaign ROI.
